---
title: "What is CAGR? Simple Explanation with Real-World Examples"
description: "Understand Compound Annual Growth Rate (CAGR) with simple examples. Learn how to calculate it, what's a good CAGR, and how it differs from absolute returns."
pubDate: 2026-05-25
category: "Finance"
tags: ["cagr", "investment", "returns", "compound growth", "finance"]
---
...
**CAGR** = (4,50,000 / 2,00,000)^(1/5) - 1
= (2.25)^(0.2) - 1
= 1.1761 - 1
= 0.1761 or **17.61% per year**
...
1. **Hides volatility** — A smooth 15% CAGR might include years of -30% and +60%
2. **Assumes buy-and-hold** — Doesn't account for additional investments or withdrawals
3. **Past CAGR ≠ Future CAGR** — Historical returns don't guarantee future performance
4. **Doesn't show risk** — Two investments with same CAGR may have very different risk levels
